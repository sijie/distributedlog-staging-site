...
">
  ...
  <link rel="canonical" href="http://bookkeeper.apache.org/distributedlog/distributedlog-staging-site/docs/0.4.0-incubating/tutorials/main.rst" data-proofer-ignore>
...
.. _Write Records using Core Library: /distributedlog-staging-site/tutorials/basic-1

- `Write Records using Write Proxy Client`_

.. _Write Records using Write Proxy Client: /distributedlog-staging-site/tutorials/basic-2

- `Write Records to Multiple Streams`_

.. _Write Records to Multiple Streams: /distributedlog-staging-site/tutorials/basic-3

- `Atomic Write Multiple Records`_

.. _Atomic Write Multiple Records: /distributedlog-staging-site/tutorials/basic-4

- `Tail reading records from a stream`_

.. _Tail reading records from a stream: /distributedlog-staging-site/tutorials/basic-5

- `Rewind reading records by time`_

.. _Rewind reading records by time: /distributedlog-staging-site/tutorials/basic-6
...
.. _Write records to partitioned streams: /distributedlog-staging-site/tutorials/messaging-1

- `Write records to multiple streams using a load balancer`_

.. _Write records to multiple streams using a load balancer: /distributedlog-staging-site/tutorials/messaging-2

- `At-least-once Processing`_

.. _At-least-once Processing: /distributedlog-staging-site/tutorials/messaging-3

- `Exact-Once Processing`_

.. _Exact-Once Processing: /distributedlog-staging-site/tutorials/messaging-4
...
.. _Build replicated state machines: /distributedlog-staging-site/tutorials/replicatedstatemachines
...
.. _DistributedLog meets MapReduce: /distributedlog-staging-site/tutorials/analytics-mapreduce
